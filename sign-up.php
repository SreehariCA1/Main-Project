...
<input type="text" name="contactnumber" id="contactnumber" onBlur="usercontactnoAvailability()"  placeholder="e.g. 9234567890" autocomplete="off" pattern="[0-9]+" title="only numeric digit allowed" maxlength="10" required>
